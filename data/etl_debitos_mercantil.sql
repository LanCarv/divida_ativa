select 
    ...
    COUNT(db.inscr_mercantil_unico) as total_creditos_lancados,
...
inner join dim_mercantil_aquila_uni dm on db.inscr_mercantil_unico = dm.insc_merct_unico
where date_part('year', db.dt_fat_gerador) >= 2018 and db.seq_imovel_unico is Null
