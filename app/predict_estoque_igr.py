...
dados_divida = base_conjunta[
    ['cda', 'id_contribuinte', 'cpf_cnpj_existe',
     ...
     'tipo_divida', 'inscricao_divida', 'idade_divida', 'quantidade_reparcelamento', 'situacao'
     ]]
...
df = dados_totais[
    ['cda', 'id_pessoa', 'da_aberto', 'vlr_pago', 'arrecadacao_divida', 'tipo_divida', 'valor_total_da',
     'vlr_tributo', 'vlr_taxa', 'inscricao_divida', 'protesto', 'ajuizamento', 'refis', 'ajuizamento_divida', 'cpf_cnpj_existe',
    'atividade_principal', 'idade_divida', 'quantidade_reparcelamentos', 'qtd_notas_2anos',
...
df_feature_store = df[['valor_total_da', 'idade_divida', 'quantidade_reparcelamentos',
